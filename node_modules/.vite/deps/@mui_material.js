...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match, setMatch] = React31.useState(() => {
    if (noSsr && matchMedia) {
...
var maybeReactUseSyncExternalStore = React31["useSyncExternalStore"];
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const getDefaultSnapshot = React31.useCallback(() => defaultMatches, [defaultMatches]);
  const getServerSnapshot = React31.useMemo(() => {
    if (noSsr && matchMedia) {
      return () => matchMedia(query).matches;
    }
  ...
  const [getSnapshot, subscribe] = React31.useMemo(() => {
    if (matchMedia === null) {
      return [getDefaultSnapshot, () => () => {
      }];
    }
...
function HiddenJs(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(React33.Fragment, {
    children
  });
}
...
var Slider = React58.forwardRef(function Slider2(inputProps, ref) {
  ...
  return (0, import_jsx_runtime64.jsxs)(RootSlot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime63.jsx)(RailSlot, _extends({}, railProps)), (0, import_jsx_runtime63.jsx)(TrackSlot, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime63.jsx)(ValueLabelComponent, _extends({}, !isHostComponent(ValueLabelComponent) && {
        valueLabelFormat,
        valueLabelDisplay,
...
var Step = React63.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime69.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime68.jsxs)(React63.Fragment, {
...
var StepButton = React68.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React68.cloneElement(children, childProps) : (0, import_jsx_runtime76.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
...
var Stepper = React71.forwardRef(function Stepper2(inProps, ref) {
  ...
  const steps = childrenArray.map((step, index) => {
    return React71.cloneElement(step, _extends({
      index,
...
var SwipeableDrawer = React73.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  const {
    ...
    variant = "temporary"
  } = props, ModalPropsProp = _objectWithoutPropertiesLoose(props.ModalProps, _excluded56), other = _objectWithoutPropertiesLoose(props, _excluded213);
  ...
  return (0, import_jsx_runtime82.jsxs)(React73.Fragment, {
    children: [(0, import_jsx_runtime81.jsx)(Drawer_default, _extends({
      ...
      onClose,
      ref
    }, other)), !disableSwipeToOpen && variant === "temporary" && (0, import_jsx_runtime81.jsx)(NoSsr, {
...
"use client";
var _excluded57 = ["className", "disabled", "disableFocusRipple", "fullWidth", "icon", "iconPosition", "indicator", "label", "onChange", "onClick", "onFocus", "selected", "selectionFollowsFocus", "textColor", "value", "wrapped"];
...
var Tab = React74.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime83.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime83.jsxs)(React74.Fragment, {
      children: [icon, label]
...
var TableBody = React76.forwardRef(function TableBody2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiTableBody"
  });
